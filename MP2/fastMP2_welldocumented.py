...
#psi4 gave us our integrals in chemists notation
    ...
    for j in range(nocc):
        for a in range(nvirt):
            for b in range(nvirt):
                energy_denom = (orb_energies[i]+orb_energies[j]-orb_energies[a+nocc]-orb_energies[b+nocc])
                fast_EMP2 += ((1/4)*I_mo_MP2[i, j, a, b]**2) / energy_denom
